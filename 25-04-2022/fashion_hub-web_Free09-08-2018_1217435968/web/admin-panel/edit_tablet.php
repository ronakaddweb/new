...
$query = mysqli_query($con, "select * from Tablet where Pid=$a") or die("Error in query");
...
if(isset($_POST['update'])){
  ...
  else
  {
    ...
    $demo= "update Tablet set Brand='$pbrand',Storage='$storage', Color='$pcolor', Price='$pprice',Description='$pdescription' ,Image_path='$pimg' where pid = '$pid'";
    echo $demo;
