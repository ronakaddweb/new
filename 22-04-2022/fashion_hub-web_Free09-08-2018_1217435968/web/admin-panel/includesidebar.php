            ...
            <div class="sidebar-scrollbar">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    ...
                    <a class="sidenav-item-link" href="laptop.php"  data-target="#components">
...
>
                        ...
                        <li  class="has-sub" >
                          <a class="sidenav-item-link" href="shirts.php"  data-target="#components"
>
...
>
                        ...
                        <li  class="has-sub" >
                          <a class="sidenav-item-link" href="tablet.php"  data-target="#components"
>
