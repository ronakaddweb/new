...
$query = mysqli_query($con, "select * from Laptop where Pid=$a") or die("Error in query");
...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
                        ...
                        <div class="form-group">
													...
													<input type="text" class="form-control" name='processor' value='<?php echo $processor ?>' placeholder="Processor">
												</div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
													...
													<input type="text" class="form-control" name='discription' value ='<?php echo $description ?>' placeholder="Discription">
												</div>
...
if(isset($_POST['update'])){
  ...
  else
  {
    ...
    $demo= "update Laptop set Brand='$pbrand',Storage='$storage', Processor='$pprocessor', Color='$pcolor', Price='$pprice',Discription='$pdescription' ,Image_path='$pimg' where pid = $pid";
    echo $demo;
