...
<input type='text' name='ram' value='<?php echo $ram ?>'><br>
...
if(isset($_POST['insert'])){
    ...
    $demo= "update Tablet set Brand= '$pbrand', Color='$pcolor', Ram='$pram', Storage='$storage', Weight='$pweight',Image_path='$pimg' where pid = '$pid'";
    echo $demo;
