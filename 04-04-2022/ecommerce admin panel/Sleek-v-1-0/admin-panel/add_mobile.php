...
<form method="post" enctype="multipart/form-data">
    <div> 
        <table>
            ...
            <tr>
                <td>Storage</td>
                <td><input type="text" name="storage" placeholder = "Storage" required></td>
            </tr>
            <tr>
                <td>Ram</td>
                <td><input type="text" name="ram" placeholder="processor" required></td>
            </tr>
            <tr>
                <td>Color</td>
...
if(isset($_POST['insert'])){
    ...
    $query = mysqli_query($con, "insert into Mobile values('$pid','$brand','$color', '$ram','$storage' ,'$weight', '$filepath')")  or die ("error in query");
