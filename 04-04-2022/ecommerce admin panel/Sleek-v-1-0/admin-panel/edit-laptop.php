...
<input type='text' name='storage' value='<?php echo $storage ?>' ><br>
<input type='text' name='processor' value='<?php echo $processor ?>'><br>
...
if(isset($_POST['insert'])){
    ...
    $demo= "update Laptop set Pid=$pid,Brand= '$pbrand', Storage='$storage', Processor='$pprocessor', Color='$pcolor', Weight='$pweight','$discription', Image_path='$pimg' where pid = $pid";
    echo $demo;
