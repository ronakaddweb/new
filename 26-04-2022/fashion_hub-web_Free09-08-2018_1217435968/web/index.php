...
<body>
        ...
        ?>
                <div class="col-sm-3">
                    <div class="hovereffect">
                        <img class="img-fluid" src=<?php echo "admin-panel/" . $img ?> alt="">
                        <div class="overlay">
                            <h5><?php echo $name ?></h5>
    ...
    <section class="tabs_pro  pt-sm-3">
        ...
        try {
            $pdo1 = new PDO("mysql:host=localhost;dbname=task3", "root", "");
            $sql1 = "select * from Category";
            $q1 = $pdo1->query($sql1);
            $q1->setFetchMode(PDO::FETCH_ASSOC);
            while ($row1 = $q1->fetch()) {

                $img1 = $row1['Image_path'];
                $name1 = $row1['Category_name'];
                ...
                <div class="tabs tabs-style-line">
                    ...
                    <div id="clothing-nav-content" class="tab-content py-sm-5">
                        ...
                        <div id="owl-demo" class="owl-carousel text-center">
                          yy  <?php
                            $sql2 = "select * from $name1 limit 0,4";
                            $q2 = $pdo->query($sql2);
                            $q2->setFetchMode(PDO::FETCH_ASSOC);
                            while ($row2 = $q2->fetch()) {

                                $img2 = $row2['Image_path'];
                                $brand2 = $row2['Brand'];
                                $name2 = $row2['Name'];
                                ...
                                <div class="item">
                                    ...
                                    <div class="card product-men p-3">
                                        <div class="men-thumb-item">
                                            <img src="<?php echo $img2 ?>" alt="img" class="card-img-top" height=290px width=310px>
                                        ...
                                        <div class="card-body  py-3 px-2">
                                            <h5 class="card-title text-capitalize"><?php echo $brand2 . " " . $name2 ?></h5>
