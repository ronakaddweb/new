...
$query = mysqli_query($con, "select * from Shoes Pid=$a") or die("Error in query");
...
if(isset($_POST['update'])){
  ...
  else
  {
    ...
    $demo= "update Shoes set Brand='$pbrand',Size='$size', Color='$pcolor', Price='$pprice',Description='$pdescription' ,Image_path='$pimg' where pid = '$pid'";
    echo $demo;
