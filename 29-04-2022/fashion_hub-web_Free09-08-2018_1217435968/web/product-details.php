                ...
                <div class="col-lg-8 mt-lg-0 mt-5 single-right-left simpleCart_shelfItem">
                    ...
                    <div class="occasion-cart">
                        <div class="chr single-item single_page_b">
                            ...
                            <a href="cartinsert.php" data-toggle="modal" data-target="#myModal1"></a>
                                <?php echo "<a href=cartinsert.php?id=$id&name=$name type=submit ><i class='fa fa-shopping-cart hub-cart phub-cart btn'>ADD TO CART</i></a>";?>
                                </button>
                                <a href="wishlist_insert.php" data-toggle="modal" data-target="#myModal1"></a>
                                <?php echo "<a href=wishlist_insert.php?id=$id&name=$name&email=$email type=submit ><i class='fa fa-heart-o hub-cart phub-cart btn'>ADD TO WISHLIST</i></a>";?>
