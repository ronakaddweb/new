                                ...
                                <div class="pay_info">
                                    <div class="vertical_post check_box_fpay">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <form  method="post">
                                            <input class="btn btn-primary submit" type="submit" name="Done" value="Make Payment">
...
$mail->Username = "ronak.j.addweb@gmail.com"; // SMTP username
$mail->Password = "Addweb^543"; // SMTP password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;

$mail->From = "ronak.j.addweb@gmail.com";
$mail->FromName = "Ronak Jain";

$mail->AddAddress("jainronak390@gmail.com");
$mail->AddReplyTo("jainronak390@gmail.com", "Hello");
