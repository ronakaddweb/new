...
<!-- Sidebar end=============================================== -->
	...
	<?php
					...
					try{
						...
						$sql="select * from Watches where Pid=$id1";
						$q=$pdo->query($sql);
	...
	<div class="row">	  
			...
			<?php echo "<a href=watch_details.php><img src='$img'></a>" ?>
            </a>
			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  ...
				  <?php echo "<a href=.php?id=$id&img=$img&name=$name&price=$price&brand=$brand type=submit class='btn btn-large btn-primary pull-right'> Add to Cart ></a>";?>
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2"><?php echo $b ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model:</td><td class="techSpecTD2"><?php echo $proc ?></td></tr>
