...
<!-- Sidebar end=============================================== -->
	...
	<?php
					...
					try{
						...
						$sql="select * from Mobile where Pid=$id1";
						$q=$pdo->query($sql);
	...
	<div class="row">	  
			...
			<?php echo "<a href=mobile_details.php><img src='$img'></a>" ?>
            </a>
			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					...
					<?php echo "<a href=cart_insert.php?id=$id&img=$img&name=$name&price=$price&brand=$brand class='btn btn-large btn-primary pull-right'> Add to Cart </a>";?>
					  <!-- <button type="submit" class="btn btn-large btn-primary pull-right"> Wishlist <i class=" icon-shopping-cart"></i></button> -->
