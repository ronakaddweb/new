...
<!-- Sidebar end=============================================== -->
	...
	<div class="control-group">
	  ...
	  <div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="address2" placeholder="Adress line 2" name="address_line"/> <span>Apartment, suite, unit, building, floor, etc.</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="postcode" placeholder="Zip / Postal Code" name="postal_code"/> 
			</div>
		</div>
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large btn-success" type="submit" value="Register" name="insert" />
			</div>
		</div>		
	</form>
</div>
...
if(isset($_POST['insert'])){
	...
	$var = "insert into User_register values('$fname','$lname','$email', $mobile ,'$address', '$address_line', '$city',$postal_code,'$password')";
//    echo $var;
